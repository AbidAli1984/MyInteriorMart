...
{
    public class DashboardHistoryGetRegisteredUsers : ViewComponent
    {
        private readonly IDashboardUserHistory userHistory;
        public DashboardHistoryGetRegisteredUsers(IDashboardUserHistory userHistory)
        {
        ...
        {
            var result = await userHistory.GetRegisteredUsersAsync(subtractDays);
            return View(result);
        }
    }
}