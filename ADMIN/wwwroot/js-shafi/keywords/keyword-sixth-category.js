...
$(document).ready(function () {
    ...
    $("#error").hide();
    $("#ModalSuccess").hide();
    $("#CreateKeyword").click(function (event) {
        ...
        var FifthCategoryID = $("#fifthCategoryId").val();
        var SixthCategoryID = $("#sixthCategoryId").val();
        ...
        if (FirstCategoryID != "" && SecondCategoryID != null && ThirdCategoryID != null && FourthCategoryID != null && FifthCategoryID != null && SixthCategoryID != null && Keyword != "" && URL != "" && Title != "" && Description != "") {
            ...
            $.ajax({
                type: 'POST',
                url: '/AllKeywords/KeywordsSixthCategory/Create',
                type: 'POST',
                async: true,
                dataType: 'json',
                data: {
                    ...
                    SixthCategoryID: SixthCategoryID,
                    Keyword: Keyword,
                    URL: URL,
                    Title: Title,
