        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SuspendedId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SuspendedTo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SuspendedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SuspendedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Suspended = table.Column<bool>(type: "bit", nullable: false),
                    ReasonForSuspending = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UnsuspendedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UnsuspendedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReasonForUnsuspending = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZoneOfCountry = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoleCategoryAndRoleID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoleCategoryID = table.Column<int>(type: "int", nullable: false),
