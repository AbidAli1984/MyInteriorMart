...
namespace DAL.DBContexts.LISTING.Migrations
{
    ...
    [Migration("20230928133142_AddStatusRemoveApprovedColInListingTable")]
    partial class AddStatusRemoveApprovedColInListingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BOL.LISTING.Keyword", b =>
                {
            ...
            modelBuilder.Entity("BOL.LISTING.ListingEnquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("EnquiryTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.BannerDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.CertificationDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.ClientDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.GalleryImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.LogoImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.OwnerImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BOL.LISTING.Address", b =>
                {
                    b.HasOne("BOL.LISTING.Listing", "Listing")
                        .WithOne("Address")
                        .HasForeignKey("BOL.LISTING.Address", "ListingID")
            ...
            modelBuilder.Entity("BOL.LISTING.UploadImage.LogoImage", b =>
                {
                    b.HasOne("BOL.LISTING.Listing", "Listing")
                        .WithOne("LogoImage")
                        .HasForeignKey("BOL.LISTING.UploadImage.LogoImage", "ListingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
