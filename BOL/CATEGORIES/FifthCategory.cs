...
{
    [Table("FifthCategory", Schema = "cat")]
    public class FifthCategory
    {
        [Key]
        [Display(Name = "Category ID")]
        public int FifthCategoryID { get; set; }
        ...
        // Shafi: Show Fifth Category in Following Categories
        public IList<SixthCategory> SixthCategory { get; set; }
        // End:

        // Shafi: Show Fifth Category in Following Keywords
