...
{
    [Table("KeywordSixthCategory", Schema = "cat")]
    public class KeywordSixthCategory
    {
        [Key]
        [Display(Name = "Keyword ID")]
        public int KeywordSixthCategoryID { get; set; }
        ...
        [Display(Name = "Sixth Category", Prompt = "Select Sixth Category")]
        [Required(ErrorMessage = "Select Sixth Category")]
        public Nullable<int> SixthCategoryID { get; set; }
        ...
        public virtual SixthCategory SixthCategory { get; set; }
        // End:
    }
}
