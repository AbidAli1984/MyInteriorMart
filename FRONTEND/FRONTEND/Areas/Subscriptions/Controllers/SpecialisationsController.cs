...
namespace FRONTEND.Areas.Subscriptions.Controllers
{
    ...
    public class SpecialisationsController : Controller
    {
        ...
        public SpecialisationsController(ListingDbContext listingContext, UserManager<IdentityUser> userManager, IHistoryAudit audit, IListingManager listingManager)
        {
